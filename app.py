...
def main():
    ...
    accv=st.number_input("Enter the Vertical Acceleration from the Sensor")
    accf=st.number_input("Enter the frontal Acceleration from the Sensor")
    accl=st.number_input("Enter the lateral Acceleration from the Sensor")
